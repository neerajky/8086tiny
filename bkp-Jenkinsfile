node{
    try {
      ...
      stage('Build Artifacts'){
        [$class: 'CopyArtifact', filter: 'build/*', fingerprintArtifacts: true, flatten: true, projectName: 'neerajky/8086tiny/tests', selector: [$class: 'SpecificBuildSelector', buildNumber: '${BUILD_NUMBER}']]
      }
